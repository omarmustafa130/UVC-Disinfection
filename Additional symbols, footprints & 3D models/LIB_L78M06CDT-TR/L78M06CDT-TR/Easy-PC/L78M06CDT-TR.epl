SamacSys ECAD Model
179504/962533/2.50/3/2/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "L78M06CDT-TR" (originalName "L78M06CDT-TR")
	...
	(compDef "L78M06CDT-TR" (originalName "L78M06CDT-TR") (compHeader (numPins 3) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "4" (pinName "GND_(THERMALPAD)") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "L78M06CDT-TR"))
		...
		(attr "Mouser Part Number" "511-L78M06CDT-TR")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/STMicroelectronics/L78M06CDT-TR?qs=JIXmGdi%252BcuJqxLiiJI11Xw%3D%3D")
		(attr "Manufacturer_Name" "STMicroelectronics")
		(attr "Manufacturer_Part_Number" "L78M06CDT-TR")
		(attr "Description" "L78M06CDT-TR, Voltage Regulator, 0.5A 6 V, 3-Pin D-PAK")
		(attr "Datasheet Link" "http://www.st.com/web/en/resource/technical/document/datasheet/CD00000447.pdf")
		(attr "Height" "2.4 mm")
	)
